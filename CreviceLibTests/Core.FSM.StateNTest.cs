...
namespace CreviceLibTests
{
    ...
    public class StateNTest
    {
        ...
        [TestMethod]
        public void On_Do_LogicalSingleThrowStartTrigger_Test()
        {
            var root = new TestRootElement();
            using (var gm = new TestGestureMachine(root))
            {
        ...
        [TestMethod]
        public void On_Do_PhysicalSingleThrowStartTrigger_Test()
        {
            var root = new TestRootElement();
            using (var gm = new TestGestureMachine(root))
            {
        ...
        [TestMethod]
        public void On_Press_PhysicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void On_Press_LogicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void On_Do_PhysicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void On_Do_LogicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void On_Release_PhysicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void On_Release_LogicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void OnDecomposed_Press_PhysicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void OnDecomposed_Press_LogicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void OnDecomposed_Release_PhysicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        [TestMethod]
        public void OnDecomposed_Release_LogicalDoubleThrowStartTrigger_Test()
        {
            {
                var root = new TestRootElement();
                using (var gm = new TestGestureMachine(root))
        ...
        public void CreateHistoryTest()
        {
            ...
            using (var gm = new TestGestureMachine(root))
            {
                ...
                var res2 = s2.Input(TestEvents.PhysicalDoubleThrowKeys0[0].PressEvent);
                ...
                Assert.AreEqual(s3.History.Records[2].ReleaseEvent, TestEvents.PhysicalDoubleThrowKeys0[0].ReleaseEvent);
                Assert.AreEqual(s3.History.Records[2].State, s2);

                var res3 = s3.Input(TestEvents.PhysicalDoubleThrowKeys0[1].PressEvent);
                ...
                Assert.AreEqual(s4.History.Records[3].ReleaseEvent, TestEvents.PhysicalDoubleThrowKeys0[1].ReleaseEvent);
        ...
        public void AbnormalEndTriggersTest()
        {
            ...
            using (var gm = new TestGestureMachine(root))
            {
                ...
                var s4 = res3.NextState as TestStateN;
                var res4 = s4.Input(TestEvents.PhysicalDoubleThrowKeys0[0].PressEvent);
        ...
        public void FindStateFromHistoryTest()
        {
            ...
            using (var gm = new TestGestureMachine(root))
            {
                ...
                Assert.AreEqual(queryResult.SkippedReleaseEvents[1], TestEvents.PhysicalDoubleThrowKeys0[0].ReleaseEvent);
            }
        }
