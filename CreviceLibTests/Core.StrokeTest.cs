    ...
    public class StrokeTest
    {
        ...
        public void StrokeResetTest()
        {
            ...
            using (var gm = new TestGestureMachine(root, callback))
            {
                ...
                Assert.AreEqual(callback.OnStrokeResetCDE.Wait(100), true);
                callback.OnStrokeResetCDE.Reset();

                Assert.AreEqual(callback.OnStateChangedCDE.Wait(100), true);
                ...
                Assert.AreEqual(callback.OnStrokeUpdatedCDE.Wait(100), true);
