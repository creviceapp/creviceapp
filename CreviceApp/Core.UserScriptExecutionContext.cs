...
namespace CreviceApp.Core
{
    ...
    public class UserScriptExecutionContext
    {
        ...
        private readonly Config.UserConfig userConfig;
        /*
        ...
        public UserScriptExecutionContext(Config.UserConfig userConfig)
        {
        ...
        public void Tooltip(string text)
        {
            MainForm.Instance.ShowTooltip(text);
        }

        public void Baloon(string text)
        {
            MainForm.Instance.ShowBaloon(text);
        }
    }
}
