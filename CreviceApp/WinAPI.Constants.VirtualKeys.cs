...
namespace Crevice.WinAPI.Constants
{
    ...
    public static class VirtualKeys
    {
        ...
        public const int VK_OEM_2                = 0xBF; // Used for miscellaneous characters; it can vary by keyboard.
                                                            // For the US standard keyboard, the '/?' key
        public const int VK_OEM_3                = 0xC0; // Used for miscellaneous characters; it can vary by keyboard.
                                                            // For the US standard keyboard, the '`~' key
        //                  -                         0xC1-D7 // Reserved
        //                  -                         0xD8-DA // Unassigned
        public const int VK_OEM_4                = 0xDB; // Used for miscellaneous characters; it can vary by keyboard.
                                                            // For the US standard keyboard, the '[{' key
        public const int VK_OEM_5                = 0xDC; // Used for miscellaneous characters; it can vary by keyboard.
                                                            // For the US standard keyboard, the '\|' key
        public const int VK_OEM_6                = 0xDD; // Used for miscellaneous characters; it can vary by keyboard.
                                                            // For the US standard keyboard, the ']}' key
        public const int VK_OEM_7                = 0xDE; // Used for miscellaneous characters; it can vary by keyboard.
